...
> Module Leader: Haoyi Wang
> CW/W1 Weighting: 30%
>
> - [X] Set exercise 1 feedback
>   Set Exercise 1: Normalisation
>   Assumptions – mostly good, but creator/owner does not come from normalisation, but
>   System Analysis.
>   UNF - 2
>   This has not been laid out to show repeating groups – no candidate key/s
>   Most attributes are OK. Trail Summary & Features are missing
>   UserEmail is not on the webpage, nor needed
>   1NF - 1
>   This is meant to remove repeating groups – but you have not shown any.
>   Location is not a repeating group
>   2NF - 1
>   This would be part key dependency – but you have no compound/composite keys
>   3NF - 3
>   Looks at non-key dependencies – Probably none
...
>   There is no size design. Why n/a for Optionality?
...
>   “create the appropriate SQL to form at least 3 tables (including a ‘link entity’)” - No
>   link entity implemented.
...
>   Looks like it would work – but not run on data server
>   4/10
>
> Total: 45%
